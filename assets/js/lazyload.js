...
(function() {
  ...
  var lazyLoader = {
    ...
    removeObservers: function() {
      removeEventListener('scroll', lazyLoader.throttledLoad, true);
      removeEventListener('resize', lazyLoader.throttledLoad, true);
    },
    ...
    throttledLoad: function() {
      ...
      if ((now - lazyLoader.throttleTimer) >= 500) {
